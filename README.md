...
This repository contains the initial setup and the final version of the Bubble Coin project, including the basic project structure, necessary images, and icons.
...
1. **Clone the Repository**:
    ...
    ```bash
    https://github.com/expen03/bubble-coin-minigame.git
    ```
